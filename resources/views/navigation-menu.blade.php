        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <x-nav-dropdown title="Settings" align="right" width="48">
                        ...
                        <x-dropdown-link href="{{ route('images.index') }}">
                        Gallery
                        </x-dropdown-link>
                        @endcan
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            <x-jet-responsive-nav-link href="{{ route('dashboard') }}" :active="request()->routeIs('dashboard')">
                ...
                @endcan
                @can('view-any', App\Models\HomepageSetting::class)
                <x-jet-responsive-nav-link href="{{ route('homepage-settings.index') }}">
                Homepage Settings
                </x-jet-responsive-nav-link>
                @endcan
                @can('view-any', App\Models\Villa::class)
                <x-jet-responsive-nav-link href="{{ route('villas.index') }}">
                Villas
                </x-jet-responsive-nav-link>
                @endcan
                @can('view-any', App\Models\Image::class)
                <x-jet-responsive-nav-link href="{{ route('images.index') }}">
                Gallery
                </x-jet-responsive-nav-link>
                @endcan
                @can('view-any', App\Models\BrochureRequest::class)
