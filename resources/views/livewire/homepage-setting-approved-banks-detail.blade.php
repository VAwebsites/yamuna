<div>
    <div>
        ...
        <button class="button" wire:click="newApprovedBank">
            <i class="mr-1 icon ion-md-add text-primary"></i>
            @lang('crud.common.new')
        </button>
        @endcan @can('delete-any', App\Models\ApprovedBank::class)
        <button
                        ...
                        >
                            ...
                            <div class="mt-2">
                                <input
                                    type="file"
                                    name="approvedBankLogo"
                                    id="approvedBankLogo{{ $uploadIteration }}"
                                    wire:model="approvedBankLogo"
                                    @change="fileChosen"
                                />
                            </div>

                            @error('approvedBankLogo')
    ...
    <div class="block w-full overflow-auto scrolling-touch mt-4">
        <table class="w-full max-w-full mb-4 bg-transparent">
            ...
            <tbody class="text-gray-600">
                @foreach ($approvedBanks as $approvedBank)
                <tr class="hover:bg-gray-100">
                    <td class="px-4 py-3 text-left">
                        <input
                            type="checkbox"
                            value="{{ $approvedBank->id }}"
                            wire:model="selected"
                        />
                    </td>
                    <td class="px-4 py-3 text-left">
                    ...
                    <td class="px-4 py-3 text-right" style="width: 134px;">
                        ...
                        >
                            ...
                            <button
                                type="button"
                                class="button"
                                wire:click="editApprovedBank({{ $approvedBank->id }})"
                            >
